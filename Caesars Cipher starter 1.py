...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for letter in range(len(lower)):
            new= (letter + shift) % 26
            dict[lower[letter]]= lower[new]
            
        for letter in range(len(upper)):
            new= (letter + shift) % 26
            dict[upper[letter]]= upper[new]
    ...
    def apply_shift(self, shift):
        ...
        for letter in self.message_text:
            if letter.isalpha():
                shiftletter = shift_dict[letter]
                new_string += shiftletter
